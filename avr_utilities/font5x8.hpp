...
inline const uint8_t *find_character( char character)
{
    ...
    if (character >= 'a' && character <= 'z') return find_nth( lowercase, character - 'a');
    if (character >= 'A' && character <= 'Z') return find_nth( uppercase, character - 'A');
    if (character >= '0' && character <= '9') return find_nth( digits, character - '0');
    switch (character)
    {

        case '?': return find_nth( symbols, 0);
        case '!': return find_nth( symbols, 1);
        case '@': return find_nth( symbols, 3);
        case '#': return find_nth( symbols, 4);
        case '&': return find_nth( symbols, 5);
        case '(': return find_nth( symbols, 6);
        case ')': return find_nth( symbols, 7);
        case '+': return find_nth( symbols, 8);
        case '-': return find_nth( symbols, 9);
        case '=': return find_nth( symbols, 10);
        case '>': return find_nth( symbols, 11);
        case '<': return find_nth( symbols, 12);
        case '$': return find_nth( symbols, 13);
        case '*': return find_nth( symbols, 14);
        case ' ': return find_nth( symbols, 15);
        case ':': return find_nth( symbols, 16);
        case '.': return find_nth( symbols, 17);
        default:
        {
            return find_nth( symbols, 1); // question mark also for unknown symbol character
        }
    }
    return 0;
}
